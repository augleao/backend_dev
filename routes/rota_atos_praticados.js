...
router.get("/", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      ...
      message:
        process.env.NODE_ENV === "development" ? error.message : "Erro ao buscar atos",
    });
  }
});
...
router.post("/", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      error: "Erro interno do servidor",
      message:
        process.env.NODE_ENV === "development" ? error.message : "Erro ao adicionar ato",
    });
  }
});
...
router.delete("/:id", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({
      error: "Erro interno do servidor",
      message:
        process.env.NODE_ENV === "development" ? error.message : "Erro ao remover ato",
    });
  }
});
